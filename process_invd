...
def lookup_cu_values(inventory_df, anomes):
    ...
    try:
        ...
        last_cu_pai.loc[last_cu_pai["AnoMes"] != anomes, "Qt_E"] = 0
        last_cu_pai.loc[last_cu_pai["AnoMes"] != anomes, "CU_E"] = last_cu_pai.loc[last_cu_pai["AnoMes"] != anomes, "CU_F"]
        last_cu_pai.loc[last_cu_pai["AnoMes"] != anomes, "CU_S"] = last_cu_pai.loc[last_cu_pai["AnoMes"] != anomes, "CU_F"]
